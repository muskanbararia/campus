        	...
        	<div class="largedetail">
            	...
            	<div class="largebox"> 
                	...
                	<div class="socialbox" style="background-color:#f4f4f4">
                    	<div class="link">
                                            	...
                                            	<a href="approve.php?title=<?php echo $id ?>" title="Apply Now">
                        <input type="button" value="Approve Now" title="Apply Now" class="bluebtn" /> </a>
              ...
              <div class="acform">
               <ul>
                ...
                <div class="whitediv"><a href="approve.php?title=<?php echo $id ?>" title="Apply Now">
                        <input type="button" value="Approve Now" title="Apply Now" class="bluebtn" /> </a>
