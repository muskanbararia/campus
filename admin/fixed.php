            ...
            <div id='cssmenu'>
                <ul>
                    ...
                    <li><a href="user.php" title="About Us"><i class="fa fa-smile-o"></i><br /><span>Users</span></a>
                        ...
                        <li><a href="employer-req.php" title="Services"><i class="fa fa-gear"></i><br /><span>Employer Requests</span></a>
                        
                    </li>        
                   
                    <li><a href="emp.php" title="Submit-Resume"><i class="fa fa-file-text-o"></i><br /><span>Accepted Employer</span></a>       	
                    </li>
                    <li><a href="job-app.php" title="Employers"><i class="fa fa-group"></i><br /><span>Job Application</span></a>
                    
                    </li>
                   
                    
                    <li><a href="logout.php" title="Contact Us"><span><i class="fa fa-envelope"></i><br />Logout</span></a></li>
                </ul>
            </div>
