...
<div style="display:none;"><h2>Hot Jobs</h2></div>
<div style="display:none;"><h3>Manpower Consultant</h3></div>
<div style="display:none;"><h4>Executive Search</h4></div>
<div style="display:none;"><h5>Outsourcing</h5></div>
<div style="display:none;"><h6>Resume Development</h6></div>

<div class="middle">
  <div class="middlediv">
    <div class="space"></div>
    <div class="onethreediv"> <a href="#" title="Why Choose Us">
      <div class="whychoose">
        <div class="imgframe">
          <div class="imglogo"><img src="img/crpl2.png" width="318" height="80" alt="Why Choose Us CRPL India"></div>
        </div>
      </div>
      </a> </div>
        ...
        <div class="ca-menu">
            <ul>
                ...
                <li title="Executive Search">
                    <a href="#">
                        <span class="ca-icon"><img src="img/services/s2.png" width="136" height="103" alt="HR Interface Services"></span>
                        <div class="ca-content">
                            <div class="ca-main" align="center">HR Interface Services</div>
                        </div>
                    </a>
                </li>
                <li title="Selection">
                    <a href="#">
                        <span class="ca-icon"><img src="img/services/s3.png" width="136" height="103" alt="Institutional Branding"></span>
                        <div class="ca-content">
                            <div class="ca-main" align="center">Institutional Branding</div>
                        </div>
                    </a>
                </li>
                <li title="Staffing">
                    <a href="#">
                        <span class="ca-icon"><img src="img/services/s4.png" width="136" height="103" alt="Freshers Guidance"></span>
                        <div class="ca-content">
                            <div class="ca-main" align="center">Freshers Guidance</div>
                        </div>
                    </a>
                </li>
                <li title="HR Consulting">
                    <a href="#">
                        ...
                        <div class="ca-content">
                            <div class="ca-main" align="center">HR Management</div>
                        </div>
                    </a>
                </li>
                <li title="Outsourcing">
                    <a href="#">
                        <span class="ca-icon"><img src="img/services/s6.png" width="136" height="103" alt="Campus Guidance"></span>
                        <div class="ca-content">
                            <div class="ca-main" align="center">Campus Guidance</div>
                        </div>
                    </a>
                </li>
                <li title="Training">
                ...
                <li title="Assesment">
                    <a href="#">
                        <span class="ca-icon"><img src="img/services/s8.png" width="136" height="103" alt="Corporate Services"></span>
                        <div class="ca-content">
                            <div class="ca-main" align="center">Corporate Services</div>
                        </div>
                    </a>
                </li>
                <li title="Code Of Conduct">
                    <a href="#">
                        ...
                        <div class="ca-content">
                            <div class="ca-main" align="center">Tier Wise Assistant</div>
                        </div>
                    </a>
                </li>
            </ul>
...
<div class="middle middlebg">
  <div class="middlediv">
    <div class="smallheadline">Featured Services</div>
    <div class="imagelist">
      <ul>
        <a href="#" title="HR Services">
        <li><span><i class="fa fa-link"></i>
          <div class="text">HR<br>
            Interface</div>
          </span><img src="img/hr.jpg" width="253" height="238" alt="Hr Services"></li>
        </a> <a href="#" title="Software Training">
        <li><span><i class="fa fa-link"></i>
          <div class="text">Institutional <br>
            Branding</div>
          </span><img src="img/training.jpg" width="221" height="238" alt="Software Training"></li>
        </a> <a href="#" title="Call Center Training">
        <li><span><i class="fa fa-link"></i>
          <div class="text">Freshers<br>
             Guidance</div>
          </span><img src="img/callcenter.png" width="221" height="238" alt="Call Center Training"></li>
        </a> <a href="#" title="Online Exam">
        <li class="imglast"><span><i class="fa fa-link"></i>
          <div class="text">Corporate <br>
            Services & Training</div>
          </span><img src="img/it.jpg" width="253" height="238" alt="Online Exam Programme"></li>
        </a>
      </ul>
    </div>
  </div>
  ...
  <div class="orange">
    ...
    <div class="middlediv">
      <div class="twotwodiv">
        <div class="orleft">
          <div class="smallheadline white">You're in Good Hand</div>
          <div class="textcontentleft white"> With our cost effective solutions and customized strategy we make a sense for specific needs and objectives of an organization, Our HR solutions provides an economical way to procure talent to your organization. Be it a single professional to complement your team or an entire work-force. We have in-house capabilities and resources to handle the most challenging aspects of your recruitment process (advertisement, prescreening dedicated resources. <br>
            <a href="#">Know More</a> </div>
        </div>
      </div>
      <div class="twotwodiv">
        <div class="textcontentright white">
          <div class="smallheadline white">What We Offer </div>
          <div class="twotwodiv">
            <div class="whiteul">
              <ul>
                <li><a href="#">Recruitment Process</a></li>
                <li><a href="#" title="Search">HR Interface </a></li>
                <li><a href="#">Institutional Branding</a></li>
                <li><a href="#" title="Staffing">Campus Services</a></li>
                <li><a href="#" title="Flexi Staffing">Corporate Services</a></li>
                <li><a href="#" title="In-house Services">Training</a></li>
              </ul>
            </div>
          </div>
          <div class="twotwodiv">
            <div class="whiteul">
              <ul class="whiteul">
                <li><a href="#" title="HR Consulting">HR Consulting</a></li>
                <li><a href="#" title="Outsourcing">Other services</a></li>
                <li><a href="#" title="Assessment">Placement Coordination</a></li>
                <li><a href="#" title="Training"> Training & Deploy Model</a></li>
                <li><a href="#" title="Code of Conduct">Personalized Attention</a></li>
                <li><a href="#" target="_blank"  title="Resume Development">Resume Development</a></li>
              </ul>
            </div>
          </div>
        </div>
  ...
  <div class="smallspace"></div>
  <div class="middlediv"> <a href="#">
    <div id="imgscroll" class="owl-carousel">
      <div class="item"><img src="img/client/ayoki_fabricon.gif" width="100%" height="60" title="Ayoki Fabricon" alt="Ayoki Fabricon"></div>
      <div class="item"><img src="img/client/century_wells.png" width="100%" height="60" title="Century Wells" alt="Century Wells"></div>
      <div class="item"><img src="img/client/AISCO.png" width="100%" height="60" title="Aisco" alt="Aisco"></div>
      <div class="item"><img src="img/client/brg_logo.png" width="100%" height="60" title="Brg" alt="Brg"></div>
      <div class="item"><img src="img/client/claritalabs.png" width="100%" height="60" title="Claritalabs" alt="Claritalabs"></div>
      <div class="item"><img src="img/client/csm.gif" width="100%" height="60" title="CMS" alt="CMS"></div>
      <div class="item"><img src="img/client/dtdc_logo.gif" width="100%" height="60" title="DTDC" alt="DTDC"></div>
      <div class="item"><img src="img/client/Fenesta.png" width="100%" height="60" title="Fenesta" alt="Fenesta"></div>
      <div class="item"><img src="img/client/Ferro_Alloys.png" width="100%" height="60" title="Ferro Alloys" alt="Ferro Alloys"></div>
      <div class="item"><img src="img/client/geepee_mobile.png" width="100%" height="60" title="Geepee Mobile" alt="Geepee Mobile"></div>
      <div class="item"><img src="img/client/HHV_Solar_Logo.png" width="100%" height="60" title="HHV Solar" alt="HHV Solar"></div>
      <div class="item"><img src="img/client/icici-logo.png" width="100%" height="60" title="Icici Secruites" alt="Icici Secruites"></div>
      <div class="item"><img src="img/client/ingvisya.png" width="100%" height="60" title="ING Visya" alt="ING Visya"></div>
      <div class="item"><img src="img/client/kotaklogo.jpg" width="100%" height="60" title="Kotak" alt="Kotak"></div>
      <div class="item"><img src="img/client/lanco.png" width="100%" height="60" title="Lanco" alt="Lanco"></div>
      <div class="item"><img src="img/client/logo-future-generali-india.gif" width="100%" height="60" title="Future Generali" alt="Future Generali"></div>
      <div class="item"><img src="img/client/magma_logo1.png" width="100%" height="60" title="Magma" alt="Magma"></div>
      <div class="item"><img src="img/client/powermax.png" width="100%" height="60" title="Powermax" alt="Powermax"></div>
      <div class="item"><img src="img/client/Ultrafresh.png" width="100%" height="60" title="Ultrafresh" alt="Ultrafresh"></div>
      <div class="item"><img src="img/client/real_ispat_logo.png" width="100%" height="60" title="Real Ispat" alt="Real Ispat"></div>
      <div class="item"><img src="img/client/lanco.png" width="100%" height="60" title="Lanco" alt="Lanco"></div>
      <div class="item"><img src="img/client/sardalogo.png" width="100%" height="60" title="Sarada" alt="Sarada"></div>
      <div class="item"><img src="img/client/Star_Union.png" width="100%" height="60" title="Star Union" alt="Star Union"></div>
      <div class="item"><img src="img/client/steag_logo.png" width="100%" height="60" title="Steag" alt="Steag"></div>
      <div class="item"><img src="img/client/sunflag.gif" width="100%" height="60" title="Sunflag" alt="Sunflag"></div>
      <div class="item"><img src="img/client/swash.jpg" width="100%" height="60" title="Swash" alt="Swash"></div>
      <div class="item"><img src="img/client/vnr.png" width="100%" height="60" title="VNR" alt="VNR"></div>
    </div>
    </a> </div>
</div>
...
<div class="middle colorbg">
	<div class="middlediv">
    	<div class="smallspace"></div>
    	<div class="twotwodiv">
        
        
        <div id="chat" class="owl-carousel">
...
Overall Campus Catalyst is still one of the top firms..</div></a>
                        ...
                        <div class="chatpeople">
                        	<div class="people"><img src="img/blank_user.png" alt="User" width="50" height="50"></div>
                            <div class="name"><span class="bold">Mr. B Swain</span><br> Daily Dukaan</div>
                        </div>
...
Campus Catalyst HR Solutions is one of the best organizations in India for getting quality heads. They excel in their Deliveries, commitments to the best of customer satisfaction. Overall good and committed Organization. Our future needs and requirements for quality manpower the simplest equations Campus Catalyst HR Solutions only.</div>
                    ...
                    <div class="chatpeople">
                        	<div class="people"><img src="img/blank_user.png" alt="User" width="50" height="50"></div>
                            <div class="name"><span class="bold">Deepak Kumar Nath</span><br> Global Tech Promoters</div>
                        </div>
                </div>
            </div>
...
<div class="chatpeople">
                        	<div class="people"><img src="img/blank_user.png" alt="User" width="50" height="50"></div>
                            <div class="name"><span class="bold">Debiprasad Jena </span><br> IBM Group</div>
                        </div>
                </div>
            </div>     
...
<div id="footer">
    ...
    <div class="copyright">
        <div class="flink">
        <a href="#" target="_blank" title="Disclaimer">Home</a>
        |
