...
<div style="display:none;"><h1>Quality Policy</h1></div>
<div style="display:none;"><h2>Standardization</h2></div>
<div style="display:none;"><h3>Time Saver</h3></div>

<div class="middle">
	<div class="middlediv">
    	<div class="smallspace"></div>
        <div class="himg"><img src="img/quality_policy.jpg" title="Quality Policy" alt="quality policy"></div>
        <div class="fivethree">
        	<div class="leftmenu">
            	<ul>
                ...
                <li><a href="quality.php" title="Quality Policy" class="active"><span>Quality Policy</span></a></li>
        ...
        <div class="fivefour">
        	<div class="largedetail lleft">
                <div class="fulldiv">
                    <div class="acforminfo"><i class="fa fa-home"></i> <i class="fa fa-angle-right"></i> <b>Quality Policy</b></div>
                </div>
                <div class="fulldiv">
                     <p>Providing a service  that meets and effectively responds to the needs   of its Client/applicant is one  of important need. That is why customer   welfare is the goal of all the actions  carried out by the company to   achieve excellence in its services.<br><br>
    To do so, it  is not sufficient to attend the needs, complaints,   suggestions and desires of  our customers and to satisfy them fully, but   it is also necessary to include  added value and to provide a level of   quality in accordance with their expectations.  In pursuit of this   objective, Corporate Resources has become the one of the Hr  recruitment   consultancy to commit itself to implementing and surpassing the    requirements, providing the best guaranteed service at competitive   prices.</p>
  <ul class="listsmallicon">
    <li>"Corporate Resources"  aims to be a global player in   job consultancy business by attaining its growth  through Branch   networking, Brand building and technology adoption.</li>
    <li>"Corporate  Resources" assures relevancy, promptness   and transparency in all endeavors  to the clients, to build and maintain   professional relationship.</li>
    <li>"Corporate  Resources" is committed to comply with   requirements of Quality Management  System and continually improve its   effectiveness.</li>
  </ul>
  <ul class="listsmallicon">
    <li><strong>Standardization</strong></li>
  </ul>
  <ul class="listsmallicon">
    <li>Webelieve  in investing time and   attention towards the qualitative and faster service  delivery.  We   believe that transparency  in relationship is required with our client   to meet the mutual interest.</li>
  </ul>
  <ul class="listsmallicon">
    <li><strong>Time Saver </strong></li>
  </ul>
  <ul class="listsmallicon">
    <li>We understand the exigency of time and sensitivity.    Thus, we not only try to deliver our services as per the time constraint   but  also take care of the special need of our clients.</li>
  </ul>
  <p><strong><em>Our ultimate goal  is to provide service that is:</em></strong></p>
  <ul class="listsmallicon">
    <li>Regular  and punctual</li>
    <li>Reliable  and trust worthy </li>
...
<div id="pop2" class="needpopup">
    ...
    <form action="http://www.crplindia.com/index.php?actid=67&amp;Path=Dynamic&amp;pth=010" method="post" onSubmit="return validate(this);">
	...
	<div class="footerdiv">
      ...
      <div class="onethreediv flast">
            ...
            <div class="map"><a href="https://goo.gl/maps/Hj7TbcHy75C2" title="Find us on Google" target="_blank"><img src="img/map.jpg" alt="Map" title="Map" ></a></div>
                        ...
                        <form id="footersubscribe" action="http://www.crplindia.com/index.php?actid=73&amp;Path=Dynamic&amp;pth=010" method="post">
...
<!-- Mirrored from www.crplindia.com/index.php?actid=010&path=Quality-Policy&P-id=1746l1deAgef5915 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 May 2017 07:13:24 GMT -->
</html>