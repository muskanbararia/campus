        ...
        <div class="fivefour">
        	<div class="largedetail">
                <div class="fulldiv">
					...
					<form  id="form1" action="reg-emp.php" method="POST"   enctype="multipart/form-data"> 
				...
				<?php
                    ...
                    {  
                        ...
                        $check_if_package="select * from emp WHERE email='$email'";
                        ...
                        $insert_package="insert into emp (name, email, mobile,password) VALUE ('$name','$email','$phone','$pwd')";  
