...
<div style="display:none;"><h1>Why Choose Us</h1></div>
<div style="display:none;"><h2>Free quotes</h2></div>
<div style="display:none;"><h3>We’re experts</h3></div>
<div style="display:none;"><h4>We guarantee our client services</h4></div>
<div style="display:none;"><h5>Services</h5></div>
<div style="display:none;"><h6>We deliver business solutions</h6></div>

<div class="middle">
	<div class="middlediv">
    	<div class="smallspace"></div>
        <div class="himg"><img src="img/whychose.jpg" title="Why Choose Us" alt="Why Choose Us"></div>
        <div class="fivethree">
        	<div class="leftmenu">
            	<ul>
                ...
                <li><a href="why-choose-us.php" title="Why Choose Us" class="active"><span> Why Choose Us</span></a></li>
        ...
        <div class="fivefour">
        	<div class="largedetail lleft">
                <div class="fulldiv">
                    <div class="acforminfo"><i class="fa fa-home"></i> <i class="fa fa-angle-right"></i> <b>Why Choose Us</b></div>
                </div>
                <div class="fulldiv">
                    <p><strong>
                  We want you to be happy. 100% of our business comes from referrals and repeat clients, so it's important to us that our clients are happy with our work.</strong>
                   <br><br>
...
<br><br>
<strong>We’re experts.</strong>
<br>
Our Each employee of our recruitment team has at least 5 +  years HR experience, much of it in corporate Sector.
<br><br>
<strong>We guarantee our client services</strong>
<br>
We provide innovative approaches for each of our client's unique needs. We have in-house capabilities and resources to handle the most challenging aspects of your recruitment process (advertisement, prescreening dedicated resources, and negotiation). We add velocity & value to your recruitment efforts with an additional level of support.
<br><br>
...
<br><br>
<strong>We’re contactable & responsive.</strong>
<br>
Have you ever been frustrated by an organisation that is difficult to contact? Usually, we’re available to take your call but if we aren’t and you leave a message then we’ll call you back within 4 business hours
<br><br>
<strong>We deliver business solutions.</strong>
<br>
We’re not geeks or nerds who mumble incomprehensible techno-babble. Instead, we apply technology to deliver business solutions that enable new capabilities, improve the efficiency of your business and help you communicate more effectively.
<br><br>
<strong>We Listen.</strong>
<br>
We understand that although there are common themes, each business is different and has its own special needs. Instead of shoe-horning every business into a “one size fits all” product, we take the time to work with you design a solution that fits like a glove.
<br><br>
<strong>We provide peace of mind.</strong>
<br>
Because we provide a fixed price and guarantee our work, you can rest assured that you won’t have any unpleasant surprises. And later, you can be sure that we’ll be there to help.
<br><br>
<strong>We have a proven methodology.</strong>
<br>
We’ve developed and refined our methods over many years, so you can expect our services.        
                   </p>
...
<div id="pop2" class="needpopup">
    ...
    <form action="http://www.crplindia.com/index.php?actid=67&amp;Path=Dynamic&amp;pth=050" method="post" onSubmit="return validate(this);">
	...
	<div class="footerdiv">
      ...
      <div class="onethreediv flast">
            ...
            <div class="map"><a href="https://goo.gl/maps/Hj7TbcHy75C2" title="Find us on Google" target="_blank"><img src="img/map.jpg" alt="Map" title="Map" ></a></div>
                        ...
                        <form id="footersubscribe" action="http://www.crplindia.com/index.php?actid=73&amp;Path=Dynamic&amp;pth=050" method="post">
...
<!-- Mirrored from www.crplindia.com/index.php?actid=050&path=Why-Choose-Us&P-id=1746l1deAgef5915 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 May 2017 07:09:15 GMT -->
</html>