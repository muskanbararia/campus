...
<title>Submit Resume - Campus  Catalyst</title>
<meta name="description" content="Submit your resume with Corporate Resources and Ease your jobs search. Free Resume Submit">
<meta name="keywords" content="Submit Resume - Corporate Resources">
...
<div style="display:none;"><h1>Submit your Resume</h1></div>
        ...
        <div class="fivefour">
        	<div class="largedetail">
                <div class="fulldiv">
                    ...
                    <div class="acform">
                        ...
                        <ul>
                            ...
                            <li>
                            <div class="ac50">
                            <select name="year" required size="1" id="year">
                            ...
                            <div class="aclast50">
                            <select name="month" required size="1" id="month">
                        ...
                        <ul>
                            ...
                            <li>
                            	<div class="ac10"><input name="cnt_code" value="+91" readonly type="text" required></div>
                        ...
                        <ul>
                        	<li>Highest Qualification <i class="star">*</i></li>
                            <li>
                            <select name="qualification" required onchange="getChildData(this.name,this.options[this.selectedIndex].value);">
                            <option value="">Select(s)</option>
                            <option style="font-weight:bold; background-color:#E1E9F7; " disabled="disabled" value="">---<b>UG Qualification</b>---</option>
                            
                                                        <option value="67" >B.Tech/B.E</option>
                                                        <option value="21" >Bachelor of Architecture (B.Arch)</option>
                                                        <option value="1" >Bachelor of Arts (B.A)</option>
                                                        <option value="27" >Bachelor of Business Administration (B.B.A) </option>
                                                        <option value="30" >Bachelor of Commerce (B.Com) </option>
                                                        <option value="24" >Bachelor of Computer Applications (B.C.A)</option>
                                                        <option value="36" >Bachelor of Dental Science (B.D.S)</option>
                                                        <option value="33" >Bachelor of Education (B.Ed)</option>
                                                        <option value="39" >Bachelor of Hotel Management (B.H.M) </option>
                                                        <option value="42" >Bachelor of Pharmacy (B.Pharma)</option>
                                                        <option value="45" >Bachelor of Science (B.Sc)</option>
                                                        <option value="146" >Bachelor of Veterinary Science (B.V.Sc) </option>
                                                        <option value="127" >Diploma</option>
                                                        <option value="121" >LLB</option>
                                                        <option value="124" >MBBS </option>
                                                        <option style="font-weight:bold; background-color:#E1E9F7; " disabled="disabled" value="">---<b>PG Qualification</b>---</option>
                                                        <option value="149" >Chartered Accountant (C.A)</option>
                                                        <option value="152" >Company Secretary (C.S)</option>
                                                        <option value="155" >ICWA</option>
                                                        <option value="158" >Integrated PG Course</option>
                                                        <option value="186" >Master of Architecture (M.Arch)</option>
                                                        <option value="167" >Master of Arts (M.A)</option>
                                                        <option value="189" >Master of Commerce (M.Com)</option>
                                                        <option value="292" >Master of Computer Applications (M.C.A) </option>
                                                        <option value="192" >Master of Education (M.Ed)</option>
                                                        <option value="164" >Master of Law (L.L.M)</option>
                                                        <option value="195" >Master of Pharmacy (M.Pharma)</option>
                                                        <option value="198" >Master of Science (M.Sc)</option>
                                                        <option value="219" >Master of Technology (M.Tech)</option>
                                                        <option value="318" >Master of Veterinary Science (M.V.Sc)</option>
                                                        <option value="274" >MBA/PGDM </option>
                                                        <option value="295" >Medical (M.S. / M.D)</option>
                                                        <option value="321" >PG Diploma</option>
                                                        
                            <option style="font-weight:bold; background-color:#E1E9F7; " disabled="disabled" value="">---<b>PHD Qualification</b>---</option>
                                                        <option value="2" >M.Phil.</option>
                                                        <option value="1" >Other Doctorate</option>
                        ...
                        <option value="zzz">Select(s)</option>
                        <option value="zzzsds">Select(s)</option>
                        ...
                        <ul>
                            ...
                            <li>
                            <select name="country" required size="1"  id="country">
                        ...
                        <ul>
                        	<li>Area(s) of Interest <i class="star">*</i></li>
                            <li>
                            <input type="text" required id="area_of_intrested" name="area_of_intrested" value=""/>
                            <div class="smalltext">Enter skills or terms that are relevant to the kind of job your looking for</div>
                            </li>
                            
                        </ul>
                        <ul>
                        	<li>Current Salary <i class="star">*</i></li>
                            <li>
                            <div class="ac50">
                            <select required name="sal_min" size="1" id="sal_min">
                            ...
                            <div class="aclast50">
                            <select required name="sal_max" size="1" id="sal_max">
                ...
                {  
                    ...
                    $city=$_POST['city'];
                    $aoi=$_POST['area_of_intrested'];
                    $lac=$_POST['sal_min'];
                    $thousand=$_POST['sal_max'];
