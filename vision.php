...
<div style="display:none;"><h1> Vision , Mission & Values</h1></div>
<div style="display:none;"><h2>Corporate Resources aim is to be the preferred choice of employers, recruitment agencies and employees.</h2></div>
<div class="middle">
	<div class="middlediv">
    	<div class="smallspace"></div>
        <div class="himg"><img src="img/vision_mission.jpg" title="Vision , Mission & Values" alt="vision mission"></div>
        <div class="fivethree">
        	<div class="leftmenu">
            	<ul>
                ...
                <li><a href="vision.php" title="Vision , Mission & Values" class="active"><span>Vision , Mission & Values
        ...
        <div class="fivefour">
        	<div class="largedetail lleft">
                <div class="fulldiv">
                    <div class="acforminfo"><i class="fa fa-home"></i> <i class="fa fa-angle-right"></i> <b>Vision , Mission & Values</b></div>
                </div>
                <div class="fulldiv">
                   
                     
  <p>Corporate Resources aim is  to be the preferred choice of   employers, recruitment agencies and employees,  thereby maintaining our   position as the leading independent recruitment company  in India.<br><br/>
    <strong>Our Vision</strong><br>
    Corporate Resources will be a world leader in innovative and   technologically  advanced HR solutions that drive businesses and enhance   quality of life for  their employees.
    <br/><br/>
    <strong>Our  Mission</strong><br>
    Corporate Resources is committed to building world class   human resource systems  for organizations. Our mission is to build value   for our clients, community and  each other. We will achieve our goal   through high standards of innovation,  research and teamwork.<br/><br/>
    
    <strong>Our  Values</strong><br>
    <b><em>Excellence</em></b> <br>
    Means that we deliver what we promise-and add value that goes   beyond what is expected. We achieve Excellence through Innovation,   Learning and Agility. <br><br/>
    <strong><em>Fairness</em></strong> <br>
    Ensure we have an impartial workplace which promotes commitment and innovation. <br><br/>
    <strong><em>Integrity</em></strong> <br>
    Being ethically unyielding and honest and inspiring trust by   saying what we mean, matching our behaviors to our words and taking   responsibility for our actions. <br><br/>
    <strong><em>Collaboration</em></strong> <br>
    We together work towards achieving long term growth for our clients, partners and benefit each other. <br><br/>
    <strong><em>Respect</em></strong> <br>
    Valuing diversity and unique contributions, fostering a trusting,   open and inclusive environment and treating each person in a manner   that reflects Corporate Resources values. Where each person feels valued   and treated with dignity. <br><br/>
    <strong><em>Innovation</em></strong> <br>
    We innovate tools and solutions to stay ahead of issues facing businesses and industry. </p>
...
<div id="pop2" class="needpopup">
    ...
    <form action="http://www.crplindia.com/index.php?actid=67&amp;Path=Dynamic&amp;pth=07" method="post" onSubmit="return validate(this);">
	...
	<div class="footerdiv">
      ...
      <div class="onethreediv flast">
            ...
            <div class="map"><a href="https://goo.gl/maps/Hj7TbcHy75C2" title="Find us on Google" target="_blank"><img src="img/map.jpg" alt="Map" title="Map" ></a></div>
                        ...
                        <form id="footersubscribe" action="http://www.crplindia.com/index.php?actid=73&amp;Path=Dynamic&amp;pth=07" method="post">
...
<!-- Mirrored from www.crplindia.com/index.php?actid=07&path=Vision-Mission&P-id=1746l1deAgef5915 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 May 2017 07:12:51 GMT -->
</html>