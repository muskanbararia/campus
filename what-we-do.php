...
<div style="display:none;"><h1>What we Do </h1></div>
<div style="display:none;"><h2>It was with this inspiration to help organizations achieve and exceed this challenge that Corporate Resources was born</h2></div>

<div class="middle">
	<div class="middlediv">
    	<div class="smallspace"></div>
        <div class="himg"><img src="img/what_we_do.jpg" title="what we do" alt="what we do"></div>
        <div class="fivethree">
        	<div class="leftmenu">
            	<ul>
                ...
                <li><a href="what-we-do.php" title="What We Do" class="active"><span>What We Do</span></a></li>
        ...
        <div class="fivefour">
        	<div class="largedetail lleft">
                <div class="fulldiv">
                    <div class="acforminfo"><i class="fa fa-home"></i> <i class="fa fa-angle-right"></i> <b>What We Do</b></div>
                </div>
                <div class="fulldiv">
                     <p>
                     Manpower is the life-blood of any organization—corporate or otherwise.    In today's day and age, no emphasis is needed to help visualize the   performance  of an organization whose people are happy vis-à-vis one   whose people aren't.  And yet, organizations exist and realize this fact   &amp; may still find it a  challenge to accomplish! <br><br>
It was with this inspiration to help organizations achieve and exceed this  challenge that Corporate Resources was born.<br><br>
<strong>Why  CORPORATE RESOURCES?</strong><br><br>
Industries and  Corporate houses spend hard earned financial resources   and time in recruiting  manpower and thus disturb the main stream of   business. In spite of hard-core  efforts, the result has not been   satisfactory. Suitable manpower is either not  available, or even if   found has been difficult to retain. Such an elusive  situation hampers   growth of the company, both structurally and financially.<br><br>
<strong>:: Bridging Gaps ::</strong><br>
<br>
We  have realized the problem and started bridging the gap between the employee and  the employer, working along to render service to the   utmost satisfaction of  customers. We take all care in accessing the   need of the employee and the  employer by providing and accepting the   necessary details from the parties.<br><br>
<strong>CORPORATE RESOURCES </strong>has  hired qualitative and best talents from the relevant industry who provides  complete and concrete   solution to HR Consulting and Placement Assistance. Our  professional   team has the proper understanding and ability to deal with the  needs of   our clients who continuously provide backend for the right and timely execution of our deals. <strong>Our professional  group incorporates Customer Care Professional, Consultants, Business  Development Team,   Financial Consultants, Lawyers, HR Professionals who  contribute their   skilled services on proper time and need.</strong><br><br>
<strong>:: Understanding Organizations ::</strong><br><br>
We believe in understanding the requirement of the  Organization, its   work culture and necessary requirements in terms of Position,    Responsibility, Reporting Hierarchy, and Compensation etc.<br><br>
<strong>:: Identifying the Best Talent ::</strong><br><br>
We screen, scrutinize and interview the candidate regarding  their   personality, qualification, skills, work history, family background and    attitude before recommending them to you.<br><br>
<strong>:: Training Services (Employment Readiness Programme) :: </strong><br><br>
We believe learning and experimentation in practice is the  best way to   reach the level of perfection, thus we put lot of stress on  training of   the new comers as well as we arrange refresher courses for the    professionals. Our approach is interactive and participatory. We provide    training on Interview Processing, Personality Development, English   Proficiency,  Professional Etiquettes, Aptitude and Attitude Build-up   and other necessary  tips required to cope-up with the intricate job   environment.<br><br>
<strong>:: Standardization ::</strong><br><br>
Webelieve in  investing time and attention towards the   qualitative and faster service  delivery.  We believe that transparency    in relationship is required with our client to meet the mutual   interest.<br><br>
<strong>:: Time Saver ::</strong><br><br>
We understand the exigency of time and sensitivity. Thus, we  not only   try to deliver our services as per the time constraint but also take care of the special need of our clients.<br><br>
<strong>:: Post Service  HELP ::</strong> <br><br>
We believe in evaluation of our performance and we keep  track   satisfaction even after proper services given. Once the candidate joins the organization, we pay regular visits to the organization, help the   candidate  to understand the need of the organization, help him to cope   up with the new  working environment
                     </p>
...
<div id="pop2" class="needpopup">
    ...
    <form action="http://www.crplindia.com/index.php?actid=67&amp;Path=Dynamic&amp;pth=05" method="post" onSubmit="return validate(this);">
	...
	<div class="footerdiv">
      ...
      <div class="onethreediv flast">
            ...
            <div class="map"><a href="https://goo.gl/maps/Hj7TbcHy75C2" title="Find us on Google" target="_blank"><img src="img/map.jpg" alt="Map" title="Map" ></a></div>
                        ...
                        <form id="footersubscribe" action="http://www.crplindia.com/index.php?actid=73&amp;Path=Dynamic&amp;pth=05" method="post">
...
<!-- Mirrored from www.crplindia.com/index.php?actid=05&path=What-We-Do&P-id=1746l1deAgef5915 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 May 2017 07:09:14 GMT -->
</html>