...
<title>Register - Campus  Catalyst</title>
        ...
        <div class="fivefour">
        	<div class="largedetail">
                <div class="fulldiv">
                       ...
                       <div class="orangeheadline"><i class="fa fa-file-text-o"></i> Log in to Campus Catalyst</div>
				...
				<?php
                    ...
                    {  
                        ...
                        $check_user="select count(*) AS pr from user WHERE email='$email' AND password='$pwd'";
