        ...
        <div class="fivefour">
        	<div class="largedetail">
                <div class="fulldiv">
                       ...
                       <div class="orangeheadline"><i class="fa fa-file-text-o"></i> Log in to QuikJobs</div>
                    <div class="acforminfo">Please fillup the form below to Submit Resume. <span><i class="star">*</i> Mark are mandatory</span></div>
					<form  id="form1" action="login-emp.php" method="POST"   enctype="multipart/form-data"> 
				...
				<?php
                    ...
                    {  
                        ...
                        $check_user="select count(*) AS pr from emp WHERE email='$email' AND password='$pwd'";
