...
<div style="display:none;"><h1> Diversity</h1></div>
<div style="display:none;"><h2>We believe the world is a rich and diverse place full of interesting cultures and people, who should be treated with respect and from whom there is a great deal to learn</h2></div>
<div class="middle">
	<div class="middlediv">
    	<div class="smallspace"></div>
        <div class="himg"><img src="img/diversity.jpg" title="Diversity" alt="Diversity"></div>
        <div class="fivethree">
        	<div class="leftmenu">
            	<ul>
                ...
                </span></a></li><li><a href="diversity.php" title="Diversity" class="active"><span>Diversity</span></a></li>
        ...
        <div class="fivefour">
        	<div class="largedetail lleft">
                <div class="fulldiv">
                    <div class="acforminfo"><i class="fa fa-home"></i> <i class="fa fa-angle-right"></i><b>Diversity</b></div>
                </div>
                <div class="fulldiv">
                     
  <p>We believe the world is a rich and diverse place full of    interesting cultures and people, who should be treated with respect and   from  whom there is a great deal to learn.<br/><br/>
  We know that employing and managing diverse people gives    us a more rounded and balanced organisation and makes us more adaptable   to new  situations. This is not simply about gender, ethnicity,   disability or age: it  is about open mindedness, embracing   non-conformity and creating balanced teams.  Respect for individuals of   all types will inspire loyalty in both employees and  customers, which   will have a direct line of sight to the achievement of  business goals.<br/><br>
    We believe in hiring a very diverse workforce. Our team    is largely comprised of the better half. Our team is from different   parts of  India, while someone comes from the east another from the   north of India. We  have quite a few people on the team who have   traversed across the length and  breadth of India across almost all   states.<br><br/>
    This rich diversity and cross cultural approach to  issues   allows us different perspectives while solving some of the most complex    HR issues.<br><br/>
    Diversity at our workplace brings an element of fun, happiness and respect for each other at the work place. We are inclusive as a team and therefore encourage people from all walks of life.<br><br/>
    We believe that everyone has a special gift to offer  and   there is always something one can learn from each other. <br/><br/>
    <strong>Definition:  What is diversity for Corporate Resources ?</strong><br/><br/>
    Diversity is a source of opportunity, whether in   employment  or customer markets. Appreciation of the rich mosaic of   difference within the  workforce fuels group dynamics and helps create   an environment where teams can  perform to their full potential. A   generalised market approach will not reach  the many pockets of value to   be found in diverse groups of customers.  Competitive edge can be   gained from the variety present in our workforce and  customer base, and   specific attention to market variation, in, for example:<br/><br/></p>
  <ul class="listsmallicon">
    <li>Age, (length of) experience</li>
    <li>Gender, sexuality</li>
    <li>Race, religion, culture, nationality</li>
    <li>Physical ability and appearance</li>
    <li>Outside, non-employment, activity and interests</li>
    <li>Personality</li>
    <li>Educational background</li>
    <li>Regional or other accents</li>
    <li>Everyone delivers the brand - it's the way we respond to  and treat customers, both internal and external</li>
    <li>To deliver a truly world class brand we need to get better  at living our values and behaviour at all levels</li>
    <li>Understanding the importance of the each individual's  contribution to business success</li>
    <li>Maximizing their potential and inspiring them</li>
    <li>Creating a framework of values and behaviors that act as  guidance</li>
    <li>Including these ideas within the basic principles that  define the organization.</li>
  </ul>
  <p><strong>So what  does a diverse organization look like ?</strong></p>
  <p>A diverse organisation is one that invites embraces and    manages difference in the changing workforce to gain the best from its   people  and to provide the best service to its customers. It encourages   the breaking  down of barriers of the past to look at things in a new   way, to find effective  business and customer solutions. In such   organisations diversity is regarded as  a competitive differentiator, in   both employment and customer markets.<br>
    Characteristics of such an organisation include:</p>
  <ul class="listsmallicon">
    <li>Recognition of diversity as a business issue. Every level  of the organization holds responsibility not just HR or Marketing</li>
    <li>The existence of a widely accepted and practiced set of  values that ensure the respect and dignity of all</li>
    <li>An environment where the insights of diverse groups   are  sought and welcomed; where people are not alienated or sidelined   because they  don't 'fit' into a set expectation</li>
    <li>Innovation and creativity are rewarded and recognized</li>
    <li>A climate where people feel that their background and    lifestyle does not affect perceptions of them as a professional, or   affect  their opportunities for development</li>
    <li>Flexible working practices are made available, as   there is  an appreciation that not everyone can and will work the same   hours and in the  same way. This removes disadvantage and discrimination   to participation in work</li>
    <li>The diverse workforce is visible at every level of the  organization and in every business area.</li>
  </ul>
  <p><strong>Objectives</strong></p>
  <ul class="listsmallicon">
    <li>Inspire both customers and employees to understand,    respect and learn from others to achieve greater personal and business   success  - to live and deliver our brand</li>
    <li>Embed diversity into the values and practices of the  organization</li>
    <li>Meet the obligations of the law and regulatory bodies</li>
    <li>Maximize and develop existing pools of talent and   skills  within CRPL that are currently under utilized and thereby to   create new  business opportunities</li>
    <li>Ensure access in recruitment to diverse groups of  potential employees</li>
    <li>Ensure access in recruitment to diverse groups of  potential customers</li>
    <li>Enhance image as Employer of Choice and HR Partner's of  Choice</li>
    <li>Ensure that all aspects of our proposition and practices  are fair and contain no structural bias.</li>
  </ul></p>
...
<div id="pop2" class="needpopup">
    ...
    <form action="http://www.crplindia.com/index.php?actid=67&amp;Path=Dynamic&amp;pth=08" method="post" onSubmit="return validate(this);">
	...
	<div class="footerdiv">
      ...
      <div class="onethreediv flast">
            ...
            <div class="map"><a href="https://goo.gl/maps/Hj7TbcHy75C2" title="Find us on Google" target="_blank"><img src="img/map.jpg" alt="Map" title="Map" ></a></div>
                        ...
                        <form id="footersubscribe" action="http://www.crplindia.com/index.php?actid=73&amp;Path=Dynamic&amp;pth=08" method="post">
...
<!-- Mirrored from www.crplindia.com/index.php?actid=08&path=Diversity&P-id=1746l1deAgef5915 by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 May 2017 07:12:59 GMT -->
</html>