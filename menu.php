        ...
        <div class="mainmenu">
            <div id='cssmenu'>
                <ul>
                    ...
                    <li>
                        <a href="#" title="About Us"><i class="fa fa-smile-o"></i><br /><span>About Us</span></a>
                        <ul>
                     ...
                     <li><a href="services.php" title="Services"><i class="fa fa-gear"></i><br /><span>Services</span></a></li>
                    <?php
                    if(isset($_SESSION['emp'])){
                        ?>
                    <li><a href="emp.php" title="Submit-Resume"><i class="fa fa-file-text-o"></i><br /><span>Post Job</span></a></li>
                    <li><a href="view-job.php" title="Submit-Resume"><i class="fa fa-file-text-o"></i><br /><span>View Submitted jobs</span></a></li>
                    <?}?>        
                   <?php
                    ...
                    <?php
                        ...
                        ?>
                           <li><a href="resume.php" title="Submit-Resume"><i class="fa fa-file-text-o"></i><br /><span>Submit Resume</span></a></li>
                ...
                <?php
                   ...
                   <?php if (!isset($_SESSION['user'])) {
                    ...
                    <li><a href="upload/form.pdf" title="About Us"><i class="fa fa-smile-o"></i><br /><span>Download Form</span></a></li>
                </ul>
            </div>
